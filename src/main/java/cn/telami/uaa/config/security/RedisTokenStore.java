...
public class RedisTokenStore implements TokenStore {
  ...
  private byte[] serialize(Object object) {
    try {
      ...
      log.error("Error to serialize the object" + object, var3);
      return null;
    }
  }
  ...
  private OAuth2AccessToken deserializeAccessToken(byte[] bytes) {
    try {
      return bytes != null ? (OAuth2AccessToken) this.objectMapper.readValue(bytes, DefaultOAuth2AccessToken.class) : null;
    } catch (Exception var3) {
      log.error("Error to deserialize the Access Token", var3);
      return null;
    }
  }
  ...
  private OAuth2Authentication deserializeAuthentication(byte[] bytes) {
    try {
      return bytes != null ? (OAuth2Authentication) this.objectMapper.readValue(bytes, OAuth2Authentication.class) : null;
    } catch (Exception var3) {
      log.error("Error to deserialize the Access Token", var3);
      return null;
    }
  ...
  private OAuth2RefreshToken deserializeRefreshToken(byte[] bytes) {
    try {
      return bytes != null ? (OAuth2RefreshToken) this.objectMapper.readValue(bytes, OAuth2RefreshToken.class) : null;
    } catch (Exception var3) {
      log.error("Error to deserialize the Access Token", var3);
      return null;
    }
